    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md">
        <div className="mb-12 text-center">
          ...
          <p className="text-muted-foreground text-sm">Automated customer retention platform</p>
        </div>
        ...
        <Card className="border-border backdrop-blur-xl bg-card/50">
          ...
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <Button type="submit" className="w-full h-11 bg-accent text-accent-foreground hover:bg-accent/90 font-medium">
                Sign in
              </Button>
            </form>
          </CardContent>
        ...
        <p className="mt-8 text-center text-sm text-muted-foreground">
          ...
          <button className="text-accent hover:text-accent/80 font-medium transition-colors">Sign up</button>
        </p>
      </div>
    </div>
  );
